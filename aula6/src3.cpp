...
#include "/home/tiago/Documents/ComputacaoGrafica/aula5/stb_image.h"
...
#include "/home/tiago/Documents/ComputacaoGrafica/glm-0.9.9.7/glm/glm/gtx/string_cast.hpp"

#include <GL/glew.h>
#include <GLFW/glfw3.h>

#include "/home/tiago/Documents/ComputacaoGrafica/Shader.hh"
...
int main()
{
    ...
    unsigned char *data = stbi_load("/home/tiago/Documents/ComputacaoGrafica/libs/myTexture2.jpg", &width, &height, &nrChannels, 0);
    if (data){
...
//                           glm::vec3(0.0f, 1.0f, 0.0f));
        ...
        for(unsigned int i = 0; i < 10; i++){
            ...
            //glm::mat4 asd2 = projectionView * model;
            //glm::mat4 asd = projection * view * model;
            
            //std::cout << glm::to_string(asd2) << std::endl;
            //std::cout << glm::to_string(asd) << std::endl;
